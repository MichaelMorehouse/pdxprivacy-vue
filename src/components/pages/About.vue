<template>
  <div id="home-content" class="page-content">
    ...
    <ul>
      <li>
        What technologies are being used to collect data about
        them
      </li>
      <li>The frequency and extent of such data collection</li>
      <li>How data is stored and how long it is retained</li>
      <li>
        What options are available to correct inaccurate
        information
      </li>
      <li>Ways they can opt out of data collection</li>
      <li>Methods available to have their stored data deleted</li>
      <li>
        How much public funding is spent on surveillance
        equipment
      </li>
      <li>
        The public benefit from the use of surveillance
        equipment
      </li>
    </ul>
    <p>The public should have input into the acquisition and use of surveillance software and equipment by government and receive reports on:</p>
    <ul>
      <li>Usage and effectiveness</li>
      <li>Data sharing</li>
